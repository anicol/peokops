...
urlpatterns = [
    ...
    path('magic-link/request/', views.request_magic_link_view, name='request-magic-link'),
    path('magic-link/verify/', views.verify_magic_link_view, name='verify-magic-link'),
    ...
    path('users/<int:pk>/assign-store/', views.assign_store_view, name='user-assign-store'),
