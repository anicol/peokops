  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        ...
        description="Part 4 of The Pivot Chronicles: Innovation isn't about what's possible. It's about what's easy. How we learned that friction kills adoption faster than any missing feature."
        keywords="startup pivots, product friction, usability, behavioral design, user adoption, SaaS lessons, product-market fit"
        ...
        tags={['Startup Journey', 'Product-Market Fit', 'Pivots', 'Usability', 'User Experience', 'SaaS']}
      />
      {/* Header */}
