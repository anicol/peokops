  ...
  return (
    <div className="min-h-screen bg-white">
      <SEO
        ...
        description="Part 3 of The Pivot Chronicles: Finally, a tangible problem! Health code violations, safety issues, cleanliness. We built AWS Rekognition, PPE detection, the works. Why impressive tech still wasn't enough."
        keywords="startup pivots, AI video analysis, computer vision, AWS Rekognition, restaurant safety, product-market fit, SaaS lessons"
        ...
        tags={['Startup Journey', 'Product-Market Fit', 'Pivots', 'AI', 'Computer Vision', 'SaaS']}
      />
      {/* Header */}
