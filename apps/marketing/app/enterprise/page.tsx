            ...
            <div className="bg-gradient-to-br from-green-50 to-teal-50 p-8 rounded-2xl border border-green-200">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-4">
                ...
                <div className="bg-white p-4 rounded-lg border border-green-200">
                  ...
                  <Link href="/coaching" className="text-green-600 hover:text-green-700 font-medium text-sm">Start Free →</Link>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-teal-50 to-blue-50 p-8 rounded-2xl border border-teal-200">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-4">
                ...
                <div className="bg-white p-4 rounded-lg border border-teal-200">
                  ...
                  <Link href="/coaching" className="text-teal-600 hover:text-teal-700 font-medium text-sm">Learn More →</Link>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-br from-blue-50 to-purple-50 p-8 rounded-2xl border border-blue-200">
              ...
              <div className="grid md:grid-cols-2 gap-6 mb-4">
                ...
                <div className="bg-white p-4 rounded-lg border border-blue-200">
                  ...
                  <Link href="/demo" className="text-blue-600 hover:text-blue-700 font-medium text-sm">Get Demo →</Link>
                </div>
              </div>
            </div>
          </div>
